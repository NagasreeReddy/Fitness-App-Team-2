...
public class CustomerLoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coustomer_login_page);
        ...
        tv_forgot_pass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CustomerLoginPage.this,ForgotPasswordActivity.class));
        ...
        btn_signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(editTextEmail.getText().toString().isEmpty()){
                    Toast.makeText(CustomerLoginPage.this, "Please Enter Valid Username", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(editTextPassword.getText().toString().isEmpty()){
                    Toast.makeText(CustomerLoginPage.this, "Please Enter Valid Password", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
                    loginUser();
        ...
        call.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                if (response.body().status.equals("true")) {
                    ...
                    Toast.makeText(CustomerLoginPage.this, response.body().message, Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<ResponseData> call, Throwable t) {
                pd.dismiss();
                Toast.makeText(CustomerLoginPage.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
